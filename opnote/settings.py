# Django settings for opnote project.
import os
import sys
...
SECRET_KEY = '1np030viixhqli7^5t5ccw$t(d#ir02a075f6^7^f9uqx9f!2g'
...
ROOT_URLCONF = 'opnote.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'opnote.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('opnote.migrations', 'opnote.tests',
                            'opnote.local_settings',
...
DEFAULT_DOMAIN = 'http://opnote.com/'

# Begins OPAL Settings you should edit !

OPAL_BRAND_NAME = 'opnote'
